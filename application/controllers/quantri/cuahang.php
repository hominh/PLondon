 ...
 */
    class Cuahang extends CI_Controller {
        protected $_data;
        ...
        public function index() {
            if ($this->login()) {
                ...
                $this->_data ['subview'] = 'backend/cuahang/index_view';
                $this->_data ['titlePage'] = 'Danh sách cửa hàng';
                $this->_data ['info'] = $this->cuahang_model->getList();
                $this->_data ['total_new'] = $this->cuahang_model->countAll();
        ...
        public function create() {
            ...
            if ($this->login()) { 
                $this->_data['titlePage'] = 'Thêm mới cửa hàng';
                $this->_data['subview'] = 'backend/cuahang/create_view';
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $this->cuahang_model->insert($data_insert);
                    $this->session->set_flashdata("flash_mess", "Added");
                    redirect(base_url() . "quantri/cuahang");
                }
                $this->load->view('backend/layout/master', $this->_data);
            }
            else {
        ...
        public function check_name($name) {
            ...
            if ($this->cuahang_model->checkName($name) == FALSE) {
    ...
    public function edit($id) {
            if ($this->login()) {
                ...
                $this->_data['subview'] = 'backend/cuahang/edit_view';
                $this->_data['info'] = $this->cuahang_model->getById($id);
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $this->cuahang_model->update($data_update,$id);
