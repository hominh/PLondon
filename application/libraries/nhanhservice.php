...
class NhanhService
{
    ...
    const URI_PRODUCT_SEARCH    ='/api/product/search';
     ...
     * @var string
     */
    protected $apiUsername = "PoshLondon";
     ...
     * @var string
     */
    protected $secretKey = "34w6yertdgvsw5eyB23465eytgQM34e5";
