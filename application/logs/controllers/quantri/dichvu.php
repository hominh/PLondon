 ...
 */
    class Dichvu extends CI_Controller {
        ...
        public function index() {
            if ($this->login()) {
                ...
                $this->_data ['subview'] = 'backend/dichvu/index_view';
                $this->_data ['titlePage'] = 'Danh sách dịch vụ';
                $this->_data ['info'] = $this->dichvu_model->getList();
                $this->_data ['total_new'] = $this->dichvu_model->countAll();
        ...
        public function create() {
            ...
            if ($this->login()) { 
                ...
                $this->_data['subview'] = 'backend/dichvu/create_view';
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $this->dichvu_model->insert($data_insert);
    ...
    public function edit($id) {
            if ($this->login()) {
                ...
                $this->_data['subview'] = 'backend/dichvu/edit_view';
                $this->_data['info'] = $this->dichvu_model->getById($id);
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $this->dichvu_model->update($data_update,$id);
