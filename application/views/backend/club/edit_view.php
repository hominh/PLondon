    ...
    <div class="maincontentinner">
        <div class="widgetbox box-inverse">
            ...
            <div class="widgetcontent wc1">
                <form class="form-horizontal" action="<?php echo base_url(); ?>quantri/clubs/edit/<?php echo $info['id']; ?>" method="post" enctype="multipart/form-data">
                <?php
				...
				?>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="name" type="text"  placeholder="Tên club" value="<?php echo $info['name']; ?>">
                        </div>
                    </div>
                    <div class="control-group">
