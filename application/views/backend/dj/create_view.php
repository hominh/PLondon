<div class="maincontent">
    <div class="maincontentinner">
        <div class="widgetbox box-inverse">
            <h4 class="widgettitle">Thêm mới dj</h4>
            <div class="widgetcontent wc1">
                <form class="form-horizontal" action="<?php echo base_url(); ?>quantri/djs/create" method="post" enctype="multipart/form-data">
                <?php
				...
				?>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="name" type="text"  placeholder="Tên dj" value="">
                        </div>
                    </div>
                    <div class="control-group">
