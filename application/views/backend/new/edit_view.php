    ...
    <div class="maincontentinner">
        <div class="widgetbox box-inverse">
            ...
            <div class="widgetcontent wc1">
                <form class="form-horizontal" action="<?php echo base_url(); ?>quantri/news/edit/<?php echo $info['id']; ?>" method="post" enctype="multipart/form-data">
                <?php
