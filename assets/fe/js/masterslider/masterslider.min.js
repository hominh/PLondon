...
window.averta = {},
    ...
    function($) {
        ...
        p._photosData = function(data) {
            ...
            this.slider.$element.css("display", "block"), this.errEle || (this.errEle = $('<div style="font-family: Open Sans, sans-serif; color:red; font-size:12px; position:absolute; top:10px; left:10px"></div>').appendTo(this.slider.$loading)), this.errEle.html(msg)
